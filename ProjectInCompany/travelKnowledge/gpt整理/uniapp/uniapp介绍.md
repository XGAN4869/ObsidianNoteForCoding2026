...
![[123.jpg]]
	...
	- 以下两种均可在插件市场Dloud/npm 中下载
		- uni 扩展组件(基于👆内置组件的二次封装如 uni-ui，比如 uni 小程序 SDK，) 和 mpvue 兼容组件
		- 微信小程序自定义组件 及 第三方SDK = 例如高德地图 SDK，微信支付SDK，等由外部厂商提供的特定功能
	- APP端支持和原生混合编码 -- 条件编译？maybe
	- H5+：具体的内容看H5+官网，目的就是解决跨端问题（通过提供增强版JS封装好的 常见的跨端API）
	- 
## 666